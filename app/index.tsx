...
export default function Index() {
    ...
    const validarEvaluacionInicial = async () => {
      try {
        ...
        const response = await fetch(`${process.env.EXPO_PUBLIC_URL}/usuarios_lecciones/leccion-inicial-finalizada/${usuario}`, {
          method: 'GET',
          headers: {
        ...
        console.log('Ocurrio un error al validar si ya completo la evaluacion inicial')
      }
    }
}
